                ...
                <div className="collapse navbar-collapse" id="mainNavBar">
                    <ul className="navbar-nav w-100">
                        <div className="mr-auto d-flex align-items-center">
                            ...
                            <CustomButton content={<NavLink to="/ask-question">Ask Question</NavLink>} />
                        </div>
                  ...
                  Topics Update
                        ...
                        {this.props.user ? (
                            <li className="nav-item dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-right" aria-labelledby="navbarUserDropdown">
                                    <NavLink className="dropdown-item" to="/my-topics">
                                        My Topics
                                    </NavLink>
                        ...
                        {this.props.user ? (
                            <li className="nav-item">
                                <NavLink className="nav-link" onClick={logout} activeClassName="" to="/">
                                    Logout
                                </NavLink>
                            </li>
                        ) : (
